...
public class AddSampleNatureHandler extends AbstractHandler {
    @Override
        ...
        if (selection instanceof IStructuredSelection) {
            ...
            while (it.hasNext()) {
                ...
                if (o instanceof IProject) {
                    try {
                        addProjectNature((IProject) o, SampleNature.ID);
                    } catch (CoreException e) {
                        throw new ExecutionException("Failed ot set nature on "
                            + o, e);
                    }
                }
            }
